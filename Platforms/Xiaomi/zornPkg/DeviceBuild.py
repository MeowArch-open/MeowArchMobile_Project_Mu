...
class CommonPlatform ():
    PackagesSupported = ("zornPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('zorn', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "zorn", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "zornPkg/zorn.dsc", "Platform Hardcoded")
